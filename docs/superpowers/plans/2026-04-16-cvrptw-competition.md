...
After Task 11, the template is complete and ready for `mengerflock new`. Running the experiment, writing the abstract, and rewriting iteration-8-improvements.md are follow-up actions done by the user.
